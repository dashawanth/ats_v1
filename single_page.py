...
def single_page():
    ...
    if submit1:
        if uploaded_file is not None:
            ...
            st.write(df[['Name', 'Phone Number', 'Email ID', 'Job Title', 'Skills']], hide_index=True, use_container_width=True)  # Display the DataFrame
            try:
                save_to_csv([data], filename=r"C:/Users/Dashu/Downloads/ATS_V1/data/resume_output.csv")  # Use raw string to handle backslashes
            except OSError as e:
